 ...
 *  on <img />
 */
export default function drawSoccerJersey({ shirtText, textColor, shirtColor = 'plain', sleeveColor, shirtStyle, shirtStyleColor, bandDirection, }, encodeToDataUri = true) {
    ...
    switch (shirtStyle) {
        ...
        case 'checkered':
            ...
            break;
        case 'single-band':
            shirtFill = drawSingleBand(page, optimizedShirtColor, (shirtStyleColor ? shirtStyleColor : '#222'), (bandDirection ? bandDirection : 'horizontal'));
            break;
        case 'hoops':
